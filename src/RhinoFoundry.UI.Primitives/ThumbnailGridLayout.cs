...
public readonly record struct FoundryThumbnailGridRect(double X, double Y, double Width, double Height)
{
...
/// </summary>
public sealed record FoundryThumbnailGridLayout(
    int ItemCount,
    int Columns,
    int Rows,
    double CardWidth,
    ...
    double Gap)
{
    ...
    public static FoundryThumbnailGridLayout Create(
        int itemCount,
    ...
    /// </summary>
    public static FoundryThumbnailGridLayout CreateForDensity(
        int itemCount,
        double availableWidth,
        double density,
        double padding = 16,
    ...
    private static FoundryThumbnailGridLayout CreateWithColumns(
        int itemCount,
        double availableWidth,
        int columns,
        IReadOnlyList<double>? paperHeightToWidthRatios,
        ...
        double gap)
    {
        ...
        return new FoundryThumbnailGridLayout(
            itemCount,
            columns,
            rows,
            cardWidth,
    ...
    public FoundryThumbnailGridRect CellBounds(int index)
    {
        ...
        return new FoundryThumbnailGridRect(
