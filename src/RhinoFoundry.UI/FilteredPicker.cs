...
public sealed class FilteredPicker : Panel
{
        ...
        Control? popupFooter = null)
    {
        ...
        var textField = new Panel
        {
            ...
            Content = new FoundryFormField(
                _textBox,
                interactionControl: null, horizontalInset: null,
    ...
    public void SetChoices(IEnumerable<string> labels)
    {
        _allLabels = labels.Distinct(StringComparer.OrdinalIgnoreCase)
            .OrderBy(label => label, StringComparer.OrdinalIgnoreCase)
            .ToArray();
    ...
    public bool ContainsChoice(string? label) =>
