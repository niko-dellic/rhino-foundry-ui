...
/// </summary>
public sealed class FoundryPaneResizeHandle : Drawable
{
    ...
    public FoundryPaneResizeHandle(
    ...
    public event EventHandler<FoundryPaneResizeEventArgs>? ResizeRequested;

    public event EventHandler? CollapseToggleRequested;

    public string LeadingPaneName { get; }
...
public enum FoundryPaneResizeAxis
{
    Horizontal,
    Vertical,
}

public sealed class FoundryPaneResizeEventArgs(int delta) : EventArgs
{
