...
/// </summary>
public sealed class FoundryAccordion : Panel
{
    public FoundryAccordion(params FoundryAccordionItem[] items)
    {
...
public sealed class FoundryAccordionItem : Panel
{
...
public sealed class FoundryAccordionTrigger : Drawable
{
    ...
    public FoundryAccordionTrigger(string title, bool isExpanded) : base(true)
    {
