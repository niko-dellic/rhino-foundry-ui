...
/// </summary>
public sealed class FoundryToolbarButtonGroup : PixelLayout
{
    ...
    public FoundryToolbarButtonGroup(params FoundryToolbarIconButton[] buttons)
    {
    ...
    {
        public CapsuleChrome() : base(false)
        {
            BackgroundColor = Colors.Transparent;
            Paint += (_, eventArgs) =>
            {
