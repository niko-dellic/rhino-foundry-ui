...
public sealed record FoundryMultiSelectChoice(string Group, string Label);

/// <summary>
/// Searchable, extensible multi-select field for compact Foundry forms.
/// </summary>
public sealed class FoundryMultiSelectField : Panel
{
    ...
    public FoundryMultiSelectField(
    ...
    public IReadOnlyList<string> Values => _selected.ToArray();
